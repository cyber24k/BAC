      ...
      <section className="bg-church-purple text-white py-16 mb-12">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-stone-300 font-light max-w-xl mx-auto text-sm md:text-base">
            Girls Christian Union — nurturing young women in faith, character, and service to God and community.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-stone-500 text-sm leading-relaxed">
            The GCU page is currently being prepared. Check back soon for updates on meetings, devotionals, and youth outreach activities.
          </p>
        </motion.div>
      </div>
    </div>
