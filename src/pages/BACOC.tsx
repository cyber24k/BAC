...
export const BACOCPage: React.FC = () => {
  return (
      ...
      <section className="bg-church-purple text-white py-16 mb-12">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-stone-300 font-light max-w-xl mx-auto text-sm md:text-base">
            Bethesda Apostolic Church On Campus — connecting and nurturing youth in tertiary institutions through faith, fellowship, and the Word of God.
          </p>
        </div>
      </section>
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <div className="w-20 h-20 bg-church-gold/10 rounded-full flex items-center justify-center mx-auto mb-6">
            <Star size={36} className="text-church-gold" />
          </div>
          <h2 className="font-serif font-bold text-2xl text-church-purple mb-3">
            Coming Soon
          </h2>
          <p className="text-stone-500 text-sm leading-relaxed">
            The BACOC page is currently being prepared. Check back soon for updates on campus fellowship meetings, tertiary outreach events, and youth programmes.
          </p>
        </motion.div>
      </div>
    </div>
