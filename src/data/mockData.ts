...
export const mockEvents: ChurchEvent[] = [
  {
    ...
    location: 'Bethsaida Temple, Highfield, Harare',
    category: 'Sunday Service',
  },
  {
    id: 'e2',
    title: 'Mothers of Bethsaida (Thursday Fellowship)',
  ...
  },
  {
    ...
    location: 'Bethsaida Temple Hall, Harare',
  ...
  {
    id: 'e6',
    title: 'Annual Bethsaida Apostolic Youth Convention',
    description: 'The national gathering of all Bethsaida youth from across Zimbabwe for spiritual enrichment, music, and leadership development.',
    date: '2026-07-24',
    time: '08:00 AM - 05:00 PM (Runs to July 26)',
    location: 'Bethsaida Headquarters Camp, Marondera',
...
export const mockNotices: Notice[] = [
  ...
  },
  {
    ...
    content: 'The Bethsaida Praise Choir will host auditions for new vocalists in all categories (Soprano, Alto, Tenor, Bass) this Saturday at 1:00 PM. Registered members, please prepare a verse and chorus of your favorite hymn.',
    date: '2026-07-01',
    category: 'Choir',
    isNew: true,
  },
...
export const mockUniforms: UniformItem[] = [
  {
    id: 'u1',
    name: 'Women\'s Standard Bethsaida Uniform',
    category: 'Women',
...
export const mockYouthEvents: YouthEvent[] = [
  {
    id: 'y1',
    title: 'Bethsaida National Youth Convention 2026',
...
export const heroCarouselImages = [
  {
    ...
    tagline: 'Bethsaida Apostolic Church welcoming all seekers of truth.',
  },
  {
    id: 'h2',
    url: '/images/women_gathering.jpg',
    caption: 'Bethsaida Praise Choir',
    tagline: 'Lifting voices to the heavens in unified worship.',
  },
  {
    id: 'h3',
    url: '/images/elders_seated.jpg',
    caption: 'Bethsaida Council of Elders',
...
export const templeGallery = [
  ...
  },
  {
    ...
    description: 'Bethsaida members singing praises in the main assembly.',
    imageUrl: '/images/women_gathering.jpg'
  }
];
